...
powershell -NoProfile -ExecutionPolicy Bypass -File (Join-Path $AutoLoopRoot "scripts\coordination\summarize-coordination-state.ps1") -ProjectRoots <target-project>
```
...
```powershell
$AutoLoopRoot = "<path-to-autoloop-root>"
powershell -NoProfile -ExecutionPolicy Bypass -File (Join-Path $AutoLoopRoot "scripts\coordination\summarize-coordination-state.ps1") -ProjectRoots <project-a>,<project-b>,<project-c>
```
